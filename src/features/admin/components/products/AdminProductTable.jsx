                  ...
                  {expandedId === productId && product.variants?.length > 0 && (
                    <TableRow key={`${productId}-variants`} className="bg-muted/20 hover:bg-muted/30">
                      <TableCell colSpan={9} className="py-3 px-4 overflow-x-auto">
                        ...
                        <div className="grid grid-cols-[40px_70px_70px_70px_70px_70px_70px_90px_90px_70px_70px_70px_90px] gap-x-2 gap-y-1.5 min-w-[940px] text-[10px] font-medium text-muted-foreground mb-1 px-1">
                          <span></span>
                          <span>Màu</span>
                        ...
                        {product.variants.map((v) => {
                          ...
                          return (
                            <div key={v.id || v._id} className="grid grid-cols-[40px_70px_70px_70px_70px_70px_70px_90px_90px_70px_70px_70px_90px] gap-x-2 gap-y-1.5 min-w-[940px] items-center text-[11px] py-1.5 px-1 rounded hover:bg-muted/50">
