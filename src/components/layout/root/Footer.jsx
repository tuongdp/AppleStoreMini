...
const SOCIAL_LINKS = [
    { name: "Facebook", href: "https://www.facebook.com/Pseidon" },
    { name: "Instagram", href: "https://www.instagram.com/dotuong/" },
    { name: "YouTube", href: "https://www.youtube.com/@phuctuongo44" },
];
                ...
                <div className="section-padding py-5">
                    <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 md:flex-row">
                        <p className="text-xs text-muted-foreground">
                            © 2026 Apple Store. Bảo lưu mọi quyền.
                        </p>
